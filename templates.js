...
function renderGuruPage() {
    ...
    const avatar = user.foto || `https://ui-avatars.com/api/?name=${encodeURIComponent(user.nama)}&background=6366f1&color=fff`;
        ...
        <main class="main-content">
            ...
            <div id="tabJadwal" class="tab-content">
                <div class="card glass">
                    ...
                    <div class="card-body">
                        <div id="guruJadwalView" class="jadwal-viewer">
                            <div class="empty-state"><i class="fas fa-spinner fa-spin"></i><p>Memuat jadwal...</p></div>
                        </div>
                    </div>
                </div>
            </div>
...
function renderAdminPage() {
    ...
    return `
        <nav class="navbar glass">
            <div class="nav-brand"><i class="fas fa-user-shield"></i><span>Admin Panel</span></div>
            <div class="nav-user">
        ...
        <div class="admin-layout">
            <aside class="sidebar glass">
                <ul class="sidebar-menu">
                    <li class="menu-item active" data-menu="dashboard"><i class="fas fa-tachometer-alt"></i><span>Dashboard</span></li>
                    <li class="menu-item" data-menu="monitoring"><i class="fas fa-eye"></i><span>Monitoring Real-Time</span></li>
                    <li class="menu-item" data-menu="users"><i class="fas fa-users"></i><span>Kelola User</span></li>
                    <li class="menu-item" data-menu="search"><i class="fas fa-search"></i><span>Cari Guru</span></li>
                    <li class="menu-item" data-menu="emptyclass"><i class="fas fa-door-open"></i><span>Kelas Kosong</span></li>
                    <li class="menu-item" data-menu="gpsradius"><i class="fas fa-map-marker-alt"></i><span>Radius GPS</span></li>
            ...
            <main class="admin-main">
                ...
                ${renderAdminUsers()}
                ${renderAdminSearch()}
                ${renderAdminEmptyClass()}
                ${renderAdminGpsRadius()}
                ${renderAdminReports()}
                ${renderAdminSettings()}
                ${renderAdminJadwal()}
                ${renderAdminSchool()}
...
function renderAdminDashboard() {
    return `
        <div id="menuDashboard" class="menu-content active">
            ...
            <!-- Notifikasi Kelas Kosong Real-time -->
            <div id="emptyClassNotification" class="notification-panel glass hidden">
                <div class="notification-header">
                    <div class="notification-title">
                        <i class="fas fa-exclamation-triangle"></i>
                        <span>Kelas Kosong Saat Ini</span>
                    </div>
                    <span id="currentJamLabel" class="current-jam-badge"></span>
                </div>
                <div id="emptyClassAlert" class="notification-body"></div>
                <button class="btn btn-secondary btn-sm notification-refresh" onclick="checkEmptyClassesRealtime()">
...
function renderAdminJadwal() {
    return `
        <div id="menuJadwal" class="menu-content">
            <h1 class="page-title"><i class="fas fa-calendar-alt"></i> Input Jadwal Pelajaran</h1>
            
            <div class="jadwal-upload-section">
                <!-- Upload Card -->
                <div class="card glass">
                    <div class="card-header"><h2><i class="fas fa-cloud-upload-alt"></i> Upload Jadwal</h2></div>
                    <div class="card-body">
                        <div id="jadwalDropzone" class="jadwal-dropzone" onclick="document.getElementById('jadwalFileInput').click()">
                            <div class="dropzone-content">
                                ...
                                <small class="dropzone-hint">Ukuran maksimal: 5MB</small>
                            </div>
                            <input type="file" id="jadwalFileInput" accept=".jpg,.jpeg,.png,.pdf" style="display:none" onchange="handleJadwalUpload(this)">
                        </div>
                        
                        <!-- Upload Progress -->
                        <div id="jadwalUploadProgress" class="upload-progress hidden">
                            <div class="progress-bar">
                                <div class="progress-fill" id="jadwalProgressFill"></div>
                            </div>
                            <p id="jadwalUploadStatus">Mengupload...</p>
                        </div>
                        ...
                        <!-- URL Input -->
                        <div class="form-group">
                            <label><i class="fas fa-link"></i> URL Jadwal (Google Drive, dll)</label>
                            <div class="url-input-group">
                                <input type="text" id="jadwalUrlInput" placeholder="https://drive.google.com/file/d/...">
                                <button class="btn btn-primary" onclick="saveJadwalFromUrl()">
                                    <i class="fas fa-save"></i> Simpan
                                </button>
                            </div>
                            <small style="color:var(--text-secondary);margin-top:6px;display:block">
                                <i class="fas fa-info-circle"></i> Untuk file PDF besar, upload ke Google Drive lalu paste link di sini
                            </small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card glass">
                    ...
                    <div class="card-body">
                        <div id="jadwalPreview" class="jadwal-preview-container">
                            <div class="empty-state">
                                <i class="fas fa-spinner fa-spin"></i>
                                <p>Memuat jadwal...</p>
                            </div>
                        </div>
                        <div id="jadwalActions" class="jadwal-actions hidden">
                            <button class="btn btn-danger" onclick="deleteJadwal()">
                                <i class="fas fa-trash"></i> Hapus Jadwal
                            </button>
                            <button class="btn btn-secondary" onclick="downloadJadwal()">
